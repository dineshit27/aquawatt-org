...
const regions = [
  { id: 1, name: "North Zone", water: 250, electricity: 180, x: 25, y: 20 },
  { id: 2, name: "South Zone", water: 320, electricity: 220, x: 60, y: 75 },
  { id: 3, name: "East Zone", water: 190, electricity: 160, x: 75, y: 35 },
  { id: 4, name: "West Zone", water: 280, electricity: 200, x: 30, y: 65 },
  { id: 5, name: "Central", water: 350, electricity: 270, x: 50, y: 50 },
];
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[80%] h-[80%] relative border-2 border-dashed border-muted-foreground/30 rounded-lg">
            ...
            <div className="absolute top-2 left-2 text-xs text-muted-foreground">City Map</div>
            <div className="absolute bottom-2 right-2 text-xs text-muted-foreground">AQUAWATT Zones</div>
          </div>
        </div>
      </div>
    </div>
